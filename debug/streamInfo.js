(function() {
    ...
    function getStreamUptimeSeconds(channelName) {
        ...
        if (createdAtDate) {
            ...
            $.consoleLn('twitchDate: ' + stream.getJSONObject('stream').getString('created_at') + ' createdAtDate: ' + createdAtDate + ' now: ' + now + ' time: ' + time + ' floor: ' + Math.floor(time / 1000));
            $.logEvent('createdAtDate', 100, 'twitchDate: ' + stream.getJSONObject('stream').getString('created_at') + ' createdAtDate: ' + createdAtDate + ' now: ' + now + ' time: ' + time + ' floor: ' + Math.floor(time / 1000));
