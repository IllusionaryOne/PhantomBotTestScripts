...
(function() {
    ...
    function registerChatCommand(script, command, groupId) {
        ...
        $.consoleLn(">> Trying to register: " + script + ": " + command);
        ...
        if ($.commandExists(command)) {
            $.consoleLn(">> FAILED to register: " + script + ": " + command + ": Command Exists");
            return;
        }
        ...
        $.consoleLn(">> Lookup: " + command + ": " + commands[command].groupId + " | " + commands[command].script);
    ...
    function commandExists(command) {
        return (commands[command] !== undefined ? true : false);
    };
    ...
    function subCommandExists(command, subcommand) {
        if (commandExists(command)) {
            return (commands[command].subcommands[subcommand] !== undefined ? true : false);
        }
        return false;
    }
